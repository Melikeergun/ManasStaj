  ...
  const fetchData = async (filter) => {
    ...
    switch (type) {
      ...
      case 'GAS':
        switch (filter) {
          case 'hourly':
            apiUrl = `http://4com.manas.com.tr/analyze/water_gas_hourly_consumption/fetch?meter_id=${meter_id}&orderby={"meter_time":"asc"}&mobile=true`;
            break;
          case 'daily':
            apiUrl = `http://4com.manas.com.tr/analyze/water_gas_daily_consumption/fetch?meter_id=${meter_id}&orderby={"meter_time":"asc"}&mobile=true`;
            break;
          case 'monthly':
            apiUrl = `http://4com.manas.com.tr/analyze/water_gas_monthly_consumption/fetch?meter_id=${meter_id}&orderby={"meter_time":"asc"}&mobile=true`;
            break;
          case 'qValue':
            apiUrl = `http://4com.manas.com.tr/history/meter_history_info/show/${meter_id}?last_history=1&render_method=json&mobile=true`;
            break;
          default:
            apiUrl = '';
        }
      ...
      case 'ELECTRICITY':
        switch (filter) {
          case 'hourly':
            apiUrl = `http://4com.manas.com.tr/analyze/electricity_consumption/fetch?meter_id=${meter_id}&mobile=true`;
            break;
          case 'daily':
            apiUrl = `http://4com.manas.com.tr/analyze/electricity_consumption/fetch?meter_id=${meter_id}&mobile=true&daily=true`;
            break;
          case 'monthly':
            apiUrl = `http://4com.manas.com.tr/analyze/electricity_consumption/fetch?meter_id=${meter_id}&mobile=true&monthly=true`;
            break;
          default:
            apiUrl = '';
        }
